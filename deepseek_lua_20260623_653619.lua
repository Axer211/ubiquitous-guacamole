--[[
    ...
    Full Feature Pack: Leaderboard, Custom Ranks, Global DMs, Ban/Unban, Translate, Fonts, Custom Avatars
    ...
    if response and response.StatusCode == 200 then
        ...
        if ok and type(data) == "table" then
            for userId, banInfo in pairs(data) do
                -- We store bans by userId, but we can also map by name later
                -- For simplicity, we'll check by userId when a player joins.
                -- We'll keep a cache of banned userIds.
...
-- ============================================================
--  DIRECT MESSAGES (now Firebase-powered)
-- ============================================================
...
-- ============================================================
--  WINDOW OPERATIONS & SEND MESSAGE (with ban/unban, etc.)
-- ============================================================
    ...
    if string.sub(txt,1,1)=="/" and CREATORS[Player.Name] then
        ...
        elseif baseCmd == "/unban" then
            ...
            if targetName then
                ...
                -- Also check offline by name (maybe)
                if FIREBASE_URL ~= "https://YOUR-PROJECT-ID-default-rtdb.firebaseio.com/" then
                    -- Could search by name in bans, but we'll just remove by userId if we know it
                end
...
-- ============================================================
--  BROADCAST JOIN & BACKGROUND POLLING (enhanced)
-- ============================================================
