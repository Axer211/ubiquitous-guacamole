--[[
    XDEMIC CHAT v15.5 | LocalScript -> StarterPlayerScripts
    Full Feature Pack + /announce command (cross-server)
--]]
...
local lastAnnounceKey = ""  -- for announcements
...
-- Scrolling frame for profile content
...
-- Helper to create a row with label and textbox (for profile fields)
...
-- ============================================================
--  WINDOW OPERATIONS & SEND MESSAGE (includes /announce)
-- ============================================================
                ...
                for key, val in pairs(data) do
                    if key > lastAnnounceKey then
                        ...
                        if not chatOpen then
                            NDot.Visible = true
                            -- Also show notification (without PFP)
