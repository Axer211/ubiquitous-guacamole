...
local function sendMsg()
    ...
    -- Normal message with 2-second cooldown
    if os.clock() - lastTextSendTime < 2 then
        addSys("⏳ Please wait 2 seconds before sending another message.")
        return
    end
    lastTextSendTime = os.clock()
